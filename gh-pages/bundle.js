...
var author$project$Main$wrap = elm$core$Task$attempt(
	function (r) {
		if (r.$ === 'Ok') {
			var data = r.a;
			return author$project$Main$Page(data);
		} else {
			var e = r.a;
...
var author$project$Page$Topic = function (a) {
	return {$: 'Topic', a: a};
};
...
var author$project$Page$Home$decodeData = function () {
	var toRecord = F2(
		function (a, b) {
			return {items: b, title: a};
		});
	var decodeRecord = A2(
	...
	return elm$json$Json$Decode$list(
		decodeRecord(
			A2(
				...
				1,
				elm$json$Json$Decode$list(decodePair))));
}();
...
var author$project$Page$Home$request = A2(elm$http$Http$get, '/data/home.json', author$project$Page$Home$decodeData);
...
var author$project$Page$Topic$request = function (path) {
	return elm$http$Http$getString('/data/' + (path + '.md'));
};
var elm$http$Http$toTask = function (_n0) {
	var request_ = _n0.a;
	return A2(_Http_toTask, request_, elm$core$Maybe$Nothing);
};
var author$project$Page$fromUrl = F2(
	function (url, key) {
		return (url.path === '/') ? _Utils_Tuple2(
			author$project$Page$Home(elm$core$Maybe$Nothing),
			A2(
				elm$core$Task$map,
				A2(elm$core$Basics$composeL, author$project$Page$Home, elm$core$Maybe$Just),
				elm$http$Http$toTask(author$project$Page$Home$request))) : _Utils_Tuple2(
			author$project$Page$Topic(elm$core$Maybe$Nothing),
			A2(
				elm$core$Task$map,
				A2(elm$core$Basics$composeL, author$project$Page$Topic, elm$core$Maybe$Just),
				elm$http$Http$toTask(
					author$project$Page$Topic$request(url.path))));
	});
		...
		switch (msg.$) {
			case 'LinkClicked':
				...
				if (urlRequest.$ === 'Internal') {
					...
					if (!_Utils_eq(url, model.url)) {
						var _n2 = A2(author$project$Page$fromUrl, url, model.key);
						var page = _n2.a;
						var task = _n2.b;
						return _Utils_Tuple2(
							_Utils_update(
			...
			case 'UrlChanged':
				var url = msg.a;
				if (!_Utils_eq(url, model.url)) {
					var _n3 = A2(author$project$Page$fromUrl, url, model.key);
					var page = _n3.a;
					var task = _n3.b;
					return _Utils_Tuple2(
						_Utils_update(
			...
			default:
				var err = msg.a;
				var _n4 = A2(elm$core$Debug$log, 'Main.Update GOT ERROR', err);
				return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
		}
	});
var elm$html$Html$Attributes$rel = _VirtualDom_attribute('rel');
var author$project$Global$fonts = _List_fromArray(
	[
		A3(
		elm$html$Html$node,
		'link',
		_List_fromArray(
			[
				elm$html$Html$Attributes$href('https://fonts.googleapis.com/css?family=Roboto:400,700&amp;subset=cyrillic'),
		...
		_List_fromArray(
			[
				elm$html$Html$Attributes$href('https://cdnjs.cloudflare.com/ajax/libs/github-markdown-css/2.10.0/github-markdown.css'),
				elm$html$Html$Attributes$rel('stylesheet')
			]),
		_List_Nil)
	]);
...
var author$project$Global$markdown = _List_fromArray(
	[
		A2(
...
var author$project$Global$snippets = _List_fromArray(
	[
		A2(
		...
		_List_fromArray(
			[
				...
				rtfeldman$elm_css$Css$Global$selector('blockquote'),
				...
				rtfeldman$elm_css$Css$Global$selector('code'),
				...
				rtfeldman$elm_css$Css$Global$selector('q'),
				...
				rtfeldman$elm_css$Css$Global$selector('i'),
				rtfeldman$elm_css$Css$Global$selector('center'),
				rtfeldman$elm_css$Css$Global$selector('dl'),
				rtfeldman$elm_css$Css$Global$selector('dt'),
				rtfeldman$elm_css$Css$Global$selector('dd'),
				...
				rtfeldman$elm_css$Css$Global$selector('aside'),
				rtfeldman$elm_css$Css$Global$canvas,
				rtfeldman$elm_css$Css$Global$selector('details'),
				...
				rtfeldman$elm_css$Css$Global$selector('menu'),
				...
				rtfeldman$elm_css$Css$Global$selector('summary'),
				rtfeldman$elm_css$Css$Global$selector('time'),
				rtfeldman$elm_css$Css$Global$selector('mark'),
				rtfeldman$elm_css$Css$Global$selector('button'),
		...
		_List_fromArray(
			[
				A2(rtfeldman$elm_css$Css$property, 'font-family', '\'Material Icons\''),
				A2(rtfeldman$elm_css$Css$property, 'font-style', 'normal'),
				A2(rtfeldman$elm_css$Css$property, 'font-weight', '400'),
				A2(rtfeldman$elm_css$Css$property, 'src', ' url(https://fonts.gstatic.com/s/materialicons/v41/flUhRq6tzZclQEJ-Vdg-IuiaDsNcIhQ8tQ.woff2) format(\'woff2\')')
			]))
	]);
...
var author$project$Global$reset = rtfeldman$elm_css$Html$Styled$toUnstyled(
	rtfeldman$elm_css$Css$Global$global(
		_Utils_ap(
			author$project$Global$snippets,
			_Utils_ap(
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								A3(rtfeldman$elm_css$Css$rgb, 66, 66, 66)),
								A2(rtfeldman$elm_css$Css$property, 'overscroll-behavior-y', 'none'),
						...
						_List_fromArray(
							[
								A2(rtfeldman$elm_css$Css$property, 'perspective', '250px'),
								A2(rtfeldman$elm_css$Css$property, 'perspective-origin', 'right center'),
								rtfeldman$elm_css$Css$backgroundImage(
								rtfeldman$elm_css$Css$url('/images/1.png')),
								rtfeldman$elm_css$Css$backgroundRepeat(rtfeldman$elm_css$Css$noRepeat),
								A2(rtfeldman$elm_css$Css$property, 'background-position', 'left bottom'),
								rtfeldman$elm_css$Css$backgroundAttachment(rtfeldman$elm_css$Css$fixed)
							]))
					]),
				author$project$Global$markdown))));
...
var author$project$MmediaQueries$desktop = rtfeldman$elm_css$Css$Media$withMedia(
	_List_fromArray(
		[
			A2(
...
var author$project$Page$Home$View$theme = {
	back1: A3(rtfeldman$elm_css$Css$rgb, 22, 48, 59),
	back2: A3(rtfeldman$elm_css$Css$rgb, 41, 93, 114),
	back3: A3(rtfeldman$elm_css$Css$rgb, 61, 138, 166),
	back4: A3(rtfeldman$elm_css$Css$rgb, 113, 172, 193),
	front: A3(rtfeldman$elm_css$Css$rgb, 240, 240, 238)
};
...
var rtfeldman$elm_css$Css$flexFlow2 = rtfeldman$elm_css$Css$prop2('flex-flow');
...
var author$project$Page$Home$View$body = A2(
	rtfeldman$elm_css$Html$Styled$styled,
	rtfeldman$elm_css$Html$Styled$section,
	_List_fromArray(
		[
			rtfeldman$elm_css$Css$backgroundColor(author$project$Page$Home$View$theme.back1),
			rtfeldman$elm_css$Css$position(rtfeldman$elm_css$Css$relative),
			rtfeldman$elm_css$Css$paddingTop(
			rtfeldman$elm_css$Css$em(1)),
			author$project$MmediaQueries$desktop(
			_List_fromArray(
				[
					rtfeldman$elm_css$Css$displayFlex,
					rtfeldman$elm_css$Css$justifyContent(rtfeldman$elm_css$Css$flexStart),
					A2(rtfeldman$elm_css$Css$flexFlow2, rtfeldman$elm_css$Css$row, rtfeldman$elm_css$Css$wrap)
				]))
		]));
...
var rtfeldman$elm_css$Css$translateZ = function (_n0) {
	var value = _n0.value;
	return {
...
var author$project$Page$Home$View$subMenu = function (_n0) {
	var item = _n0.a;
	var url = _n0.b;
	return A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										rtfeldman$elm_css$Css$translateZ(
										rtfeldman$elm_css$Css$em(1.0e-7))
									])),
								rtfeldman$elm_css$Css$hover(
								_List_fromArray(
									[
										rtfeldman$elm_css$Css$color(author$project$Page$Home$View$theme.back1),
										rtfeldman$elm_css$Css$backgroundColor(author$project$Page$Home$View$theme.front)
									]))
							])),
						...
						_List_fromArray(
							[
								...
								author$project$Page$Home$View$theme.front),
								A3(
...
var author$project$Page$Home$View$menu = F2(
	function (t, items) {
		return A4(
			rtfeldman$elm_css$Html$Styled$styled,
				...
				[
					...
					_List_fromArray(
						[
							...
							rtfeldman$elm_css$Css$em(44)),
							rtfeldman$elm_css$Css$marginLeft(
							rtfeldman$elm_css$Css$em(4)),
							rtfeldman$elm_css$Css$flexGrow(rtfeldman$elm_css$Css$zero),
							rtfeldman$elm_css$Css$displayFlex,
							A2(rtfeldman$elm_css$Css$flexFlow2, rtfeldman$elm_css$Css$column, rtfeldman$elm_css$Css$wrap),
							rtfeldman$elm_css$Css$justifyContent(rtfeldman$elm_css$Css$flexStart)
						]))
				]),
			_List_Nil,
			_Utils_ap(
				...
				A2(elm$core$List$map, author$project$Page$Home$View$subMenu, items)));
	});
...
var rtfeldman$elm_css$Css$preserve3d = {transformStyle: rtfeldman$elm_css$Css$Structure$Compatible, value: 'preserve-3d'};
var rtfeldman$elm_css$Css$right = rtfeldman$elm_css$Css$prop1('right');
var rtfeldman$elm_css$Css$rotateY = function (_n0) {
	var value = _n0.value;
	return {
		transform: rtfeldman$elm_css$Css$Structure$Compatible,
		value: A2(
...
var rtfeldman$elm_css$Css$transformStyle = rtfeldman$elm_css$Css$prop1('transform-style');
...
var author$project$Page$Home$View$page = A2(
	rtfeldman$elm_css$Html$Styled$styled,
	rtfeldman$elm_css$Html$Styled$div,
	_List_fromArray(
		[
			rtfeldman$elm_css$Css$color(author$project$Page$Home$View$theme.front),
			author$project$MmediaQueries$desktop(
			_List_fromArray(
				[
					rtfeldman$elm_css$Css$width(
					...
					rtfeldman$elm_css$Css$em(30)),
					rtfeldman$elm_css$Css$top(
					rtfeldman$elm_css$Css$em(10)),
					rtfeldman$elm_css$Css$position(rtfeldman$elm_css$Css$absolute),
					rtfeldman$elm_css$Css$display(rtfeldman$elm_css$Css$block),
					rtfeldman$elm_css$Css$backgroundColor(author$project$Page$Home$View$theme.back2),
					A2(
					rtfeldman$elm_css$Css$property,
					'box-shadow',
					_Utils_ap('0 0 0 1em ' + author$project$Page$Home$View$theme.back2.value, (',0 0 0 1.1em ' + author$project$Page$Home$View$theme.back1.value) + (', 0 0 0 2em ' + author$project$Page$Home$View$theme.back2.value))),
					rtfeldman$elm_css$Css$transformStyle(rtfeldman$elm_css$Css$preserve3d),
					rtfeldman$elm_css$Css$transforms(
					_List_fromArray(
						[
							rtfeldman$elm_css$Css$rotateY(
							rtfeldman$elm_css$Css$deg(-0.5))
						])),
					A2(rtfeldman$elm_css$Css$property, 'backface-visibility', 'hidden'),
...
var author$project$Page$Home$View$title = A2(
	rtfeldman$elm_css$Html$Styled$styled,
	...
	_List_fromArray(
		[
			...
			rtfeldman$elm_css$Css$position(rtfeldman$elm_css$Css$relative),
			rtfeldman$elm_css$Css$backgroundColor(author$project$Page$Home$View$theme.back3),
			rtfeldman$elm_css$Css$fontSize(
			rtfeldman$elm_css$Css$em(4)),
			rtfeldman$elm_css$Css$padding(
			rtfeldman$elm_css$Css$em(0.5))
		]));
var author$project$Page$Home$View$view = function (mockData) {
	return A2(
		author$project$Page$Home$View$page,
		_List_Nil,
		_List_fromArray(
			[
				A2(
				author$project$Page$Home$View$title,
				_List_Nil,
				_List_fromArray(
					[
						rtfeldman$elm_css$Html$Styled$text('Easy Way')
					])),
				A2(
				author$project$Page$Home$View$body,
				_List_Nil,
				A2(
					elm$core$List$map,
					function (data) {
						return A2(author$project$Page$Home$View$menu, data.title, data.items);
					},
					mockData))
			]));
};
var author$project$Page$Home$view = A2(
	...
	elm$core$Maybe$map(
		A2(elm$core$Basics$composeR, author$project$Page$Home$View$view, rtfeldman$elm_css$Html$Styled$toUnstyled)),
	elm$core$Maybe$withDefault(
		elm$html$Html$text('No Data for HOME')));
var elm_explorations$markdown$Markdown$toHtmlWith = _Markdown_toHtml;
var author$project$Page$Topic$view = function () {
	var options = {
	...
	var oldStuff = A2(
		...
		_List_fromArray(
			[
				...
				A2(elm$html$Html$Attributes$style, 'width', '60em'),
				A2(elm$html$Html$Attributes$style, 'margin', '0 auto'),
				A2(elm$html$Html$Attributes$style, 'padding', '3em')
			]));
	return A2(
		elm$core$Basics$composeR,
		elm$core$Maybe$map(oldStuff),
		elm$core$Maybe$withDefault(
			elm$html$Html$text('No Data for Topic')));
}();
var author$project$Page$view = function (page) {
	switch (page.$) {
		case 'Home':
			var data = page.a;
			return author$project$Page$Home$view(data);
		case 'Topic':
			var data = page.a;
			return author$project$Page$Topic$view(data);
		default:
			return elm$html$Html$text('Unknown page');
	}
};
var author$project$Main$view = function (_n0) {
	...
	return {
		body: _Utils_ap(
			author$project$Global$fonts,
			_List_fromArray(
				[
					author$project$Global$reset,
...
var author$project$Main$main = elm$browser$Browser$application(
	{
		init: F3(
			function (_n0, url, key) {
				var _n1 = A2(author$project$Page$fromUrl, url, key);
				var page = _n1.a;
				var task = _n1.b;
				return _Utils_Tuple2(
					{key: key, page: page, prevPage: elm$core$Maybe$Nothing, url: url},
					author$project$Main$wrap(task));
			}),
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"},"Page.Home.Data":{"args":[],"type":"List.List { title : String.String, items : List.List ( String.String, String.String ) }"},"Page.Topic.Data":{"args":[],"type":"String.String"},"Http.Response":{"args":["body"],"type":"{ url : String.String, status : { code : Basics.Int, message : String.String }, headers : Dict.Dict String.String String.String, body : body }"}},"unions":{"Main.Msg":{"args":[],"tags":{"LinkClicked":["Browser.UrlRequest"],"UrlChanged":["Url.Url"],"Page":["Page.Page"],"Error":["Http.Error"]}},"Page.Page":{"args":[],"tags":{"Home":["Maybe.Maybe Page.Home.Data"],"Topic":["Maybe.Maybe Page.Topic.Data"],"NotFound":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Http.Response String.String"],"BadPayload":["String.String","Http.Response String.String"]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":[]}},"List.List":{"args":["a"],"tags":{}},"Dict.NColor":{"args":[],"tags":{"Red":[],"Black":[]}}}}})}});}(this));